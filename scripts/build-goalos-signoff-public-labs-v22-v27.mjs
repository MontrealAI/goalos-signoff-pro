...
<article class="lab-card">
  ...
  <p class="promise"><b>What it demonstrates:</b> ${escapeHtml(lab.promise)}</p>
  <div class="proof-line"><b>Why it matters</b><span>${escapeHtml(lab.proof)}</span></div>
  <div class="proof-line"><b>Output artifact</b><span>${escapeHtml(lab.artifacts[0])} plus manifest-listed supporting artifacts.</span></div>
  <div class="audience"><b>Boundary</b><span>Browser-local sample demonstration only; no upload, wallet, payment, analytics, personal data, confidential data, or value movement.</span></div>
  <div class="audience"><b>Best for</b><span>${escapeHtml(lab.audience)}</span></div>
  <div class="routes"><a class="primary" href="${escapeHtml(lab.route)}">Best next click: open lab</a>${lab.aliases.slice(0, 2).map(a => `<a href="${escapeHtml(a)}">${escapeHtml(a.replace(/\.html$/, '').replace(/-/g, ' '))}</a>`).join('')}</div>
</article>`).join('\n');
...
<section class="section"><div class="section-head"><div><p class="eyebrow">Why these six labs matter</p><h2>The path from output to institutional proof.</h2></div><p>Together, v22-v27 show governed action, proof-carrying artifacts, independent replay, evidence reanalysis, mission curriculum, and process-resolved evidence — the public-safe path from output to institutional proof.</p></div><div class="matrix"><table><thead><tr><th>Lab</th><th>Institutional question</th><th>Proof discipline</th></tr></thead><tbody><tr><td>v22</td><td>Who has authority to act?</td><td>No authority, no autonomy.</td></tr><tr><td>v23</td><td>Can this artifact safely influence future work?</td><td>Reusable capability must carry proof.</td></tr><tr><td>v24</td><td>Can an independent reviewer replay the claim?</td><td>No replay, no settlement.</td></tr><tr><td>v25</td><td>Can plans be reanalyzed against evidence?</td><td>Planning remains bounded by proof.</td></tr><tr><td>v26</td><td>Can accepted proof become curriculum?</td><td>Harder missions inherit verified lessons.</td></tr><tr><td>v27</td><td>Can the process be reviewed, not just the answer?</td><td>Lineage, tool scope, and contradictions matter.</td></tr></tbody></table></div></section>
...
<footer class="footer" data-goalos-footer="canonical"><div><b>GoalOS Signoff Pro</b><br><span>Proof-to-acceptance · human authority · replay · reusable capability · evidence lineage.</span></div><nav class="nav"><a href="index.html">Start</a><a href="https://github.com/MontrealAI/goalos-signoff-pro/blob/main/docs/NO_USER_DATA_POLICY.md">No User Data</a><a href="https://github.com/MontrealAI/goalos-signoff-pro/blob/main/LEGAL.md">Legal</a><a href="https://github.com/MontrealAI/goalos-signoff-pro/blob/main/docs/AGIALPHA_EXTERNAL_TOKEN_BOUNDARY.md">$AGIALPHA boundary</a><a href="goalos-public-demo-labs-v22-v27.json">Global manifest</a></nav></footer>
