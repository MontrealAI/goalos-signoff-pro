...
pages.set('theatre.html', chrome('theatre.html', `
  <section class="page-hero compact reveal"><p class="eyebrow"><span></span>Live proof theatre</p><h1>Watch an acceptance record form.</h1><p>A browser-local theatre demonstrates the product logic: commission, submit, map, review, authorize, seal. It is a product narrative, not a hidden backend.</p></section>
  <section class="section theatre-grid reveal">
    <div class="theatre-panel"><h2>Mission control</h2><p>Launch a local proof cycle and watch each gate commit into the receipt rail.</p><div class="hero-actions"><button class="primary" type="button" data-launch-cycle>Launch proof cycle</button><button class="secondary" type="button" data-reset-cycle>Reset</button></div><pre id="cycleLog">System ready. Awaiting bounded mission.</pre></div>
    <div class="ring-panel"><div class="readiness-ring" data-score="83"><b>83</b><span>Review readiness</span></div><div class="cycle-steps"><span>01 Commission</span><span>02 Submit</span><span>03 Map</span><span>04 Review</span><span>05 Accept</span><span>06 Receipt</span></div></div>
  </section>
...
pages.set('pilot.html', chrome('pilot.html', `
  ...
  <section class="section pilot-panel reveal"><div><h2>Ideal first pilots</h2><ul><li>AI research or strategy deliverable</li><li>Automation implementation milestone</li><li>Software feature handoff</li><li>Grant or bounty milestone review</li><li>Internal AI pilot acceptance</li></ul></div><div><h2>Success signal</h2><p>Five real Signoffs attempted. Three completed end-to-end. Two users say they would use it again. Zero broken receipts.</p><a class="primary" href="mailto:contact@montreal.ai?subject=GoalOS%20Signoff%20Pro%20Private%20Beta">Request pilot access</a></div></section>
...
const manifest = {
  ...
  site: 'ASI Apex v6 Final Production',
  version,
...
write('apex-manifest.txt', `GoalOS Signoff Pro — ASI Apex v6 Final Production\n${baseUrl}\nSite hash: ${manifest.siteHash}\n`);
...
console.log(`GoalOS Signoff Pro ASI Apex v6 generated ${files.length} files at ${out}`);
